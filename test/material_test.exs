defmodule MaterialTest do
  ...
  import Light, only: [point_light: 2, lighting: 5]
  ...
  test "Lighting with the eye between the light and the surface" do
    ...
    assert lighting(m, light, position, eyev, normalv) == Color.new(1.9, 1.9, 1.9)
  end
  ...
  test "Lighting with the eye between light and surface, eye offset 45°" do
    ...
    assert lighting(m, light, position, eyev, normalv) == Color.new(1, 1, 1)
  end
  ...
  test "Lighting with eye opposite surface, light offset 45°" do
    ...
    assert lighting(m, light, position, eyev, normalv) <~> Color.new(0.7364, 0.7364, 0.7364)
  end
  ...
  test "Lighting with eye in the path of the reflection vector" do
    ...
    assert lighting(m, light, position, eyev, normalv) <~> Color.new(1.6364, 1.6364, 1.6364)
  end
  ...
  test "Lighting with the light behind the surface" do
    ...
    assert lighting(m, light, position, eyev, normalv) <~> Color.new(0.1, 0.1, 0.1)
  end
end
