defmodule RayTracer.Tasks.Chapter12 do
  @moduledoc """
  This module tests cubes from Chapter 12
  """
  ...
  def execute(w \\ 100, h \\ 50) do
    # Benchmark(fn -> RayTracer.Tasks.Chapter12.execute end)
    world = build_world()
  ...
  def red_box do
    ...
    %Cube{material: material} |> Shape.set_transform(transform)
  end

  def blue_glass_box do
    transform = Transformations.compose([
      scaling(0.7, 0.7, 0.7),
