...
defmodule RayTracer.PerturbedPattern.SimplexNoiseImproved.Utility do
...
defmodule RayTracer.PerturbedPattern.SimplexNoiseImproved.Grad do
  defstruct x: 0.0, y: 0.0, z: 0.0, w: 0.0
end

# Simplex noise in 2D, 3D and 4D
defmodule RayTracer.PerturbedPattern.SimplexNoiseImproved do
  alias RayTracer.PerturbedPattern.SimplexNoiseImproved.Grad
  import RayTracer.PerturbedPattern.SimplexNoiseImproved.Utility

  use RayTracer.PerturbedPattern.OctaveNoise.Mixin
