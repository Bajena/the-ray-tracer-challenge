...
defmodule RayTracer.PerturbedPattern.SimplexNoiseImproved.OctaveNoise do
...
defmodule RayTracer.PerturbedPattern.OctaveNoise.Mixin do
  defmacro __using__(_) do
    quote location: :keep do

      @behaviour RayTracer.PerturbedPattern.NoiseGenerator
      @behaviour RayTracer.PerturbedPattern.OctaveNoise
